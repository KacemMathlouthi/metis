...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELED', name='agent_run_status_enum'), nullable=False),
    ...
    op.create_index(op.f('ix_agent_runs_celery_task_id'), 'agent_runs', ['celery_task_id'], unique=False)
    op.create_index(op.f('ix_agent_runs_completed_at'), 'agent_runs', ['completed_at'], unique=False)
    ...
    op.create_index(op.f('ix_agent_runs_issue_number'), 'agent_runs', ['issue_number'], unique=False)
