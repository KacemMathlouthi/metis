            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {run.custom_instructions && (
                  <div className="mt-1 text-xs text-gray-500 italic truncate max-w-2xl">
                    "{run.custom_instructions}"
                  </div>
                )}
              </div>
              <div className="flex items-center gap-2 pt-1">
                {run.pr_url ? (
                  <a
                    ...
                    className="text-xs text-blue-600 hover:underline font-medium border border-blue-200 bg-blue-50 px-2 py-1 rounded-md"
                  >
                    PR #{run.pr_number}
                  </a>
                ) : run.error ? (
                  <span className="text-xs text-red-600 font-medium bg-red-50 px-2 py-1 rounded-md border border-red-200">
                    Error
                  </span>
                ) : null}
              </div>
